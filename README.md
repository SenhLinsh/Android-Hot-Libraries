...
| :----: | :----: | :----: | :----: | :----: | :----: |
| UI | Loading | [SmartRefreshLayout](https://github.com/scwang90/SmartRefreshLayout) | 智能下拉刷新框架[[详细]](#scwang90--smartrefreshlayout) | 21k | 10天 |
...
| UI | Loading | [LoadSir](https://github.com/KingJA/LoadSir) | 加载反馈页管理框架 | 2.3k | 2月 |
| UI | Loading | [LoadingView](https://github.com/ldoublem/LoadingView) | 简单的 Loading 控件 | 2.5k | 9月 |
| UI | 图表 | [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) | 统计图表库 | 31k | 22天 |
...
| UI | 菜单 | [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) | 侧滑菜单 | 11k | 2天 |
...
| UI | 日历 | [CalendarView](https://github.com/huanghaibin-dev/CalendarView ) | 高度自定义、支持周视图的日历控件 | 6.6k | 1月 |
| UI | 图片 | [PhotoView](https://github.com/chrisbanes/PhotoView) | 大图展示 | 17k | 2月 |
| UI | 图片 | [subsampling-scale-image-view](https://github.com/davemorrissey/subsampling-scale-image-view) | 大图展示 | 6.2k | 28天 |
...
| UI | 弹窗 | [Toasty](https://github.com/GrenderG/Toasty) | 定制不一样的 Toast | 5.8k | 18天 |
...
| UI | 导航 | [MagicIndicator](https://github.com/hackware1993/MagicIndicator) | ViewPager 指示器框架 | 7.8k | 3天 |
...
| UI | 轮播图 | [banner](https://github.com/youth5201314/banner) | 广告图片轮播控件 | 9.9k | 9天 |
| UI | 轮播图 | [Android-ConvenientBanner](https://github.com/saiwu-bigkoo/Android-ConvenientBanner) | 通用的广告栏控件 | 4.7k | 1年 |
| UI | WebView | [AgentWeb](https://github.com/Justson/AgentWeb) | 高度封装的 WebView | 7.2k | 3月 |
...
| UI | 其他 | [AppIntro](https://github.com/apl-devs/AppIntro) | 欢迎页 | 9.2k | 1天 |
...
| 网络 | 框架 | [retrofit](https://github.com/square/retrofit) | 网络框架 | 36k | 7天 |
| 网络 | 框架 | [okhttp](https://github.com/square/okhttp) | 网络框架 | 37k | 1天 |
| 网络 | 框架 | [volley](https://github.com/google/volley) | 网络框架 | 2.8k | 9天 |
| 网络 | 框架 | [Java-WebSocket](https://github.com/TooTallNate/Java-WebSocket) | WebSocket 框架 | 6.9k | 24天 |
...
| 网络 | 文件下载 | [okdownload](https://github.com/lingochamp/okdownload) | 文件下载引擎 | 3.7k | 5月 |
| 网络 | 进度监听 | [ProgressManager](https://github.com/JessYanCoding/ProgressManager) | okhttp 上传下载进度监听 | 2.3k | 1年 |
| 图片 | 框架 | [glide](https://github.com/bumptech/glide) | 图片框架 | 29k | 2天 |
...
| 图片 | 转换 | [glide-transformations](https://github.com/wasabeef/glide-transformations) | Glide 图像转换器 | 8.8k | 4月 |
...
| 视频 | 播放器 | [GSYVideoPlayer](https://github.com/CarGuo/GSYVideoPlayer) | 多功能视频播放器 | 14k | 8天|
| 动画 | AE | [lottie-android](https://github.com/airbnb/lottie-android) | 展示 AE 工具所作动画的框架 | 29k | 12天 |
...
| 异步 | 链式 | [RxJava](https://github.com/ReactiveX/RxJava) | 事件驱动的基于异步数据流的编程模式 | 43k | 9天 |
...
| 数据库 | 轻量级 | [realm-java](https://github.com/realm/realm-java) | 轻量级数据库 | 11k | 13天 |
...
| json | 解析 | [fastjson](https://github.com/alibaba/fastjson) | 阿里巴巴 Json 库 | 22k | 2天 |
...
| 换肤 | 框架 | [Android-skin-support](https://github.com/ximsfei/Android-skin-support) | 换肤框架 | 4.8k | 12天 |
| 语言 | 汉字处理 | [HanLP](https://github.com/hankcs/HanLP) | 中文分词 、关键词提取等 | 20k | 4月 |
| AI | 深度学习 | [TensorFlow-android](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/android) | TensorFlow Android Demo | 146k | 3月 |
...
| 性能 | 检测 | [matrix](https://github.com/Tencent/matrix) | 微信研发的应用性能接入框架 | 7.3k | 6月 |
| 性能 | 生命周期 | [RxLifecycle](https://github.com/trello/RxLifecycle) | 使用 RxJava 管理生命周期 | 7.4k | 24天 |
...
| 热修复 | 框架 | [tinker](https://github.com/Tencent/tinker) | 微信热修复框架 | 15k | 1天 |
...
| 插件化 | 框架 | [RePlugin](https://github.com/Qihoo360/RePlugin) | 插件化方案 | 6.4k | 2天 |
...
| 工具 | 工具类 | [guava](https://github.com/google/guava) | 谷歌核心 Java 类库 | 38k | 2天 |
| 工具 | 工具类 | [AndroidUtilCode](https://github.com/Blankj/AndroidUtilCode) | 安卓开发者不得不收集的代码 | 27k | 20天 |
...
| 通信 | 路由 | [ARouter](https://github.com/alibaba/ARouter) | 辅助组件化改造的框架 | 12k | 21天|
...
| 扫描 | 二维码 | [zxing](https://github.com/zxing/zxing) | 二维码扫描 | 26k | 11天 |
| 注解 | 框架 | [androidannotations](https://github.com/androidannotations/androidannotations) | 快速开发框架 | 11k | 2月 |
| 注解 | 绑定 | [butterknife](https://github.com/JakeWharton/butterknife) | 为 Android View 设计的绑定注解 | 25k | 1天 |
...
| 响应式 | UI | [RxBinding](https://github.com/JakeWharton/RxBinding) | 安卓 UI 响应式编程 | 9.4k | 29天 |
...
| hook | 框架 | [TaiChi](https://github.com/taichi-framework/TaiChi) | 非ROOT环境下运行Xposed模块的框架 | 3.3k | 5月|
| 崩溃 | 报告 | [acra](https://github.com/ACRA/acra) | 崩溃信息收集框架 | 5.3k | 9天 |
| 崩溃 | 处理 | [CustomActivityOnCrash](https://github.com/Ereza/CustomActivityOnCrash) | 崩溃处理 | 3.1k | 3月 |
| 崩溃 | 预防 | [NullAway](https://github.com/uber/NullAway) | 检测 NullPointerExceptions | 2.8k | 7天 |
...
| 混淆 | 工具 | [AndResGuard](https://github.com/shwenzhang/AndResGuard) | Android 资源混淆工具 | 6.8k | 18天 |
| 测试 | 单元测试 | [robolectric](https://github.com/robolectric/robolectric) | Android 单元测试框架 | 5k | 1天 |
| 测试 | 单元测试 | [mockito](https://github.com/mockito/mockito) | Android 单元测试框架 | 11k | 1天|
...
| 调试 | 数据库 | [Android-Debug-Database](https://github.com/amitshekhariitbhu/Android-Debug-Database) | Android 数据库调试工具 | 7.3k | 1月 |
| 调试 | 方法 | [hugo](https://github.com/JakeWharton/hugo) | 方法调试工具 | 7.4k | 4年 |
| 调试 | UI | [UETool](https://github.com/eleme/UETool) | UE调试工具 | 2.9k | 3月 |
| 调试 | 工具 | [pandora](https://github.com/whataa/pandora) | 调试工具箱 | 1.3k | 3月 |
| 反编译 | 工具 | [Apktool](https://github.com/iBotPeaches/Apktool) | 反编译 APK 工具 | 10k | 1天 |
...
| Demo | 测试 | [android-testing](https://github.com/googlesamples/android-testing) | 集成四大自动化测试框架的 Demo | 7.4k | 22天 |
| Demo | 设计模式 | [java-design-patterns](https://github.com/iluwatar/java-design-patterns) | java设计模式指南(英文 | 58k | 3天 |
| APP | 仿造 | [bilibili-android-client](https://github.com/HotBitmapGG/bilibili-android-client) | 高仿哔哩哔哩动画安卓客户端 | 4.3k | 6月 |
| APP | 播放器 | [android-UniversalMusicPlayer](https://github.com/googlesamples/android-UniversalMusicPlayer) | 谷歌教科书级音乐播放器 | 12k | 5天 |
| APP | 播放器 | [ExoPlayer](https://github.com/google/ExoPlayer) | 谷歌出品可扩展媒体播放器 | 16k | 8天 |
...
| APP | 相机 | [camera-samples](https://github.com/android/camera-samples) | 安卓相机 API 使用 Demo | 1.8k | 8天 |
...
| APP | 翻译 | [TranslateApp](https://github.com/maoruibin/TranslateApp) | 咕咚翻译 APP | 1.7k | 6月 |
...
| APP | 壁纸 | [muzei](https://github.com/romannurik/muzei) | 定时更换桌面精美壁纸 App | 4.1k | 2天 |
...
| 面试 | 指南 | [interviews](https://github.com/kdn251/interviews) | 软件工程技术面试个人指南 | 45k | 11天 |
| 面试 | 题库 | [AndroidInterview-Q-A](https://github.com/JackyAndroid/AndroidInterview-Q-A) | 国内一线互联网公司内部面试题库 | 7.7k | 28天 |
...
| 学习 | 汇总 | [AdvancedAndroid](https://github.com/SusionSuc/AdvancedAndroid) | 一系列 Android 进阶文章 | 2.2k | 8天 |
...
| 学习 | 算法 | [awesome-java-leetcode](https://github.com/Blankj/awesome-java-leetcode) | 学习数据结构和算法、刷 LeetCode | 7.5k | 8月 |
| 学习 | 算法 | [algorithm-visualizer](https://github.com/algorithm-visualizer/algorithm-visualizer) | 交互式算法学习 | 31k | 6月 |
| 学习 | ADB | [awesome-adb](https://github.com/mzlogin/awesome-adb) | ADB 用法大全 | 7.2k | 1月 |
| 学习 | 编程 | [free-programming-books](https://github.com/EbookFoundation/free-programming-books) | 编程语言学习 | 152k | 13天 |
| 学习 | 设计 | [system-design-primer](https://github.com/donnemartin/system-design-primer) | 系统设计入门 | 99k | 22天 |
| 其他 | 大全 | [Android](https://github.com/open-android/Android) | GitHub 上最火的 Android 开源项目 | 9.9k | 2年 |
| 其他 | 大全 | [awesome-java](https://github.com/akullpp/awesome-java) | Java框架、库与软件合集 | 25k | 25天 |
...
| 其他 | 大全 | [AndroidLibs](https://github.com/XXApple/AndroidLibs) | Android 开源代码大全 | 6.5k | 1月 |
...
| 其他 | 大全 | [JavaGuide](https://github.com/Snailclimb/JavaGuide) | Java 学习+面试指南 | 82k | 1天 |
| 其他 | 大全 | [advanced-java](https://github.com/doocs/advanced-java) | Java 进阶知识完全扫盲 | 45k | 1天 |
...
| 其他 | API | [public-apis](https://github.com/public-apis/public-apis) | 公共 API 接口 | 87k | 9天 |
...
| 开发工具 | 软件 | [lantern](https://github.com/getlantern/lantern) | 翻墙利器 | 4k |26天 |
...
| 开发工具 | 软件 | [scrcpy](https://github.com/Genymobile/scrcpy) | 显示和控制连接的安卓设备 | 32k | 8天 |
...
| 开发工具 | 插件 | [EdXposed](https://github.com/ElderDrivers/EdXposed) | ART hook 框架 | 2.8k | 4天 |
...
3. 『star 数』和『最近更新』是基于：2020-06-17 GitHub 项目数据进行参考。

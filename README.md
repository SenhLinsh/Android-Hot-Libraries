...
| UI | 图表 | [TableView](https://github.com/evrencoskun/TableView) | 绘制表格 | 1.8k | 14天 |
...
| UI | 图片 | [PhotoView](https://github.com/chrisbanes/PhotoView) | 大图展示 | 14k | 19天 |
| UI | 图片 | [subsampling-scale-image-view](https://github.com/davemorrissey/subsampling-scale-image-view) | 大图展示 | 4.6k | 7月 |
...
| UI | 图片 | [android-gif-drawable](https://github.com/koral--/android-gif-drawable) | Gif 加载 | 6.6k | 3天 |
| UI | 图片 | [Matisse](https://github.com/zhihu/Matisse) | 图片\视频选择库 | 8.0k | 9天 |
...
| UI | 弹窗 | [Toasty](https://github.com/GrenderG/Toasty) | 定制不一样的 Toast | 4.7k | 3天 |
...
| UI | 状态栏 | [ImmersionBar](https://github.com/gyf-dev/ImmersionBar) | 沉浸式状态栏和沉浸式导航栏管理 | 4.4k | 1月 |
...
| UI | 导航 | [MagicIndicator](https://github.com/hackware1993/MagicIndicator) | ViewPager 指示器框架 | 5.0k | 12天 |
...
| UI | 布局 | [vlayout](https://github.com/alibaba/vlayout) | 整套布局方案和组件复用[[详细]](#alibaba--vlayout) | 8.5k | 1月 |
| UI | 布局 | [rclayout](https://github.com/GcsSloop/rclayout) | Android 通用圆角布局 | 1.4k | 10天 |
...
| UI | 选择器 | [AndroidPicker](https://github.com/gzu-liyujiang/AndroidPicker) | 安卓选择器类库 | 3.9k | 1天 |
...
| UI | WebView | [AgentWeb](https://github.com/Justson/AgentWeb) | 高度封装的 WebView | 4.7k | 24天 |
| UI | 高斯模糊 | [500px-android-blur](https://github.com/500px/500px-android-blur) | 高斯模糊控件 | 2.3k | 2年 |
| UI | 高斯模糊 | [BlurKit-Android](https://github.com/wonderkiln/BlurKit-Android) | 高斯模糊控件 | 2.5k | 1天 |
...
| UI | 其他 | [QMUI_Android](https://github.com/QMUI/QMUI_Android) | 提高 UI 开发效率的 UI 库 | 5.6k | 20天 |
| 网络 | 框架 | [retrofit](https://github.com/square/retrofit) | 网络框架 | 29k | 3天 |
| 网络 | 框架 | [okhttp](https://github.com/square/okhttp) | 网络框架 | 29k | 2天 |
| 网络 | 框架 | [volley](https://github.com/google/volley) | 网络框架 | 1.9k | 8天 |
| 网络 | 文件下载 | [FileDownloader](https://github.com/lingochamp/FileDownloader) | 文件下载引擎 | 7.4k | 22天 |
| 网络 | 进度监听 | [ProgressManager](https://github.com/JessYanCoding/ProgressManager) | okhttp 上传下载进度监听 | 1.8k | 3月 |
| 图片 | 框架 | [glide](https://github.com/bumptech/glide) | 图片框架 | 23k | 4天 |
| 图片 | 框架 | [Android-Universal-Image-Loader](https://github.com/nostra13/Android-Universal-Image-Loader) | 图片框架 | 16k | 2年 |
| 图片 | 框架 | [picasso](https://github.com/square/picasso) | 图片框架 | 16k | 13天 |
| 图片 | 框架 | [fresco](https://github.com/facebook/fresco) | 图片框架 | 15k | 3天 |
| 图片 | 压缩 | [Luban](https://github.com/Curzibn/Luban) | 最接近朋友圈的图片压缩算法 | 8.5k | 2月 |
| 图片 | 转换 | [glide-transformations](https://github.com/wasabeef/glide-transformations) | Glide 图像转换器 | 6.8k | 6月 |
| 图片 | 滤镜 | [android-gpuimage](https://github.com/CyberAgent/android-gpuimage) | 图像滤镜框架 | 5.3k | 2年 |
| 图片 | 选择器 | [Matisse](https://github.com/zhihu/Matisse) | 图片视频选择器 | 8.0k | 9天 |
| 图片 | 选择器 | [TakePhoto](https://github.com/crazycodeboy/TakePhoto) | 图片选择 / 剪裁 / 压缩 | 5.6k | 6月 |
| 图片 | 选择器 | [PhotoPicker](https://github.com/donglua/PhotoPicker) | 仿微信图片选择器 | 2.7k | 25天 |
...
| 视频 | 播放器 | [GSYVideoPlayer](https://github.com/CarGuo/GSYVideoPlayer) | 多功能视频播放器 | 7.7k | 5天 |
| 动画 | AE | [lottie-android](https://github.com/airbnb/lottie-android) | 展示 AE 工具所作动画的框架 | 22k | 15天 |
...
| 动画 | 列表 | [recyclerview-animators](https://github.com/wasabeef/recyclerview-animators) | RecyclerView 条目动画 | 8.4k | 29天 |
| 动画 | 列表 | [spruce-android](https://github.com/willowtreeapps/spruce-android) | 列表视图展现动画 | 2.7k | 9月 |
...
| 数据库 | 轻量级 | [realm-java](https://github.com/realm/realm-java) | 轻量级数据库 | 9.9k | 14天 |
...
| 语言 | 汉字处理 | [HanLP](https://github.com/hankcs/HanLP) | 中文分词 、关键词提取等 | 9.1k | 1天 |
...
| 性能 | 内存 | [leakcanary](https://github.com/square/leakcanary) | 检查内存泄漏工具 | 20k | 2天 |
...
| 工具 | 工具类 | [guava](https://github.com/google/guava) | 谷歌核心 Java 类库 | 27k | 1天 |
...
| 工具 | 列表 | [BaseRecyclerViewAdapterHelper](https://github.com/CymChad/BaseRecyclerViewAdapterHelper) | RecyclerAdapter 框架 | 15k | 23天 |
...
| 键盘 | 冲突 | [JKeyboardPanelSwitch](https://github.com/Jacksgong/JKeyboardPanelSwitch) | 解决键盘面板冲突 | 3.1k | 10天 |
| 扫描 | 二维码 | [zxing](https://github.com/zxing/zxing) | 二维码扫描 | 20k | 15天 |
...
| 权限 | 请求 | [PermissionsDispatcher](https://github.com/hotchemi/PermissionsDispatcher) | 基于注解处理权限请求 | 8.1k | 27天 |
| 权限 | 请求 | [RxPermissions](https://github.com/tbruyelle/RxPermissions) | 基于 RxJava 处理权限请求 | 7.2k | 3月 |
| 响应式 | UI | [RxBinding](https://github.com/JakeWharton/RxBinding) | 安卓 UI 响应式编程 | 8.0k | 2天 |
...
| 框架 | MVP | [mosby](https://github.com/sockeqwe/mosby) | MVP 框架 | 4.9k | 5月 |
...
| 混淆 | 工具 | [AndResGuard](https://github.com/shwenzhang/AndResGuard) | Android 资源混淆工具 | 5.1k | 23天 |
| 测试 | 单元测试 | [robolectric](https://github.com/robolectric/robolectric) | Android 单元测试框架 | 4.2k | 2天 |
| 测试 | 单元测试 | [mockito](https://github.com/mockito/mockito) | Android 单元测试框架 | 7.7k | 1天 |
| 测试 | 单元测试 | [truth](https://github.com/google/truth) | 谷歌的断言和命题框架 | 1.5k | 24天 |
| 调试 | 框架 | [stetho](https://github.com/facebook/stetho) | Android 开发调试神器 | 10k | 2天 |
...
| 调试 | UI | [UETool](https://github.com/eleme/UETool) | UE调试工具 | 2.1k | 24天 |
| 反编译 | 工具 | [Apktool](https://github.com/iBotPeaches/Apktool) | 反编译 APK 工具 | 6.9k | 1月 |
| 反编译 | 工具 | [android-classyshark](https://github.com/google/android-classyshark) | APK 分析利器 | 5.2k | 2月 |
...
| Demo | 测试 | [android-testing](https://github.com/googlesamples/android-testing) | 集成四大自动化测试框架的 Demo | 5.7k | 8天 |
| Demo | 设计模式 | [java-design-patterns](https://github.com/iluwatar/java-design-patterns) | java设计模式指南(英文 | 40k | 6天 |
...
| APP | 播放器 | [ExoPlayer](https://github.com/google/ExoPlayer) | 谷歌出品可扩展媒体播放器 | 11k | 14天 |
| APP | 播放器 | [Timber](https://github.com/naman14/Timber) | 音乐播放器 | 5.2k | 8月 |
...
| APP | 壁纸 | [muzei](https://github.com/romannurik/muzei) | 定时更换桌面精美壁纸 App | 3.7k | 5天 |
| 面试 | 指南 | [interviews](https://github.com/kdn251/interviews) | 软件工程技术面试个人指南 | 29k | 8天 |
...
| 学习 | 汇总 | [AndroidNote](https://github.com/GcsSloop/AndroidNote) | GcsSloop 个人学习笔记 | 5.6k | 14天 |
...
| 学习 | 算法 | [awesome-java-leetcode](https://github.com/Blankj/awesome-java-leetcode) | 学习数据结构和算法、刷 LeetCode | 4.5k | 5月 |
...
| 其他 | 大全 | [awesome-java](https://github.com/akullpp/awesome-java) | Java框架、库与软件合集 | 18k | 1天 |
| 其他 | 大全 | [awesome-android](https://github.com/JStumpp/awesome-android) | Android 实用资源合集 | 6.0k | 2天 |
...
| 其他 | 大全 | [awesome-android-tips](https://github.com/jiang111/awesome-android-tips) | 收集常用的 Android 代码 | 2.3k | 8天 |
...
| 补充 | 开发工具 | [PocketHub](https://github.com/pockethub/PocketHub) | Android 版 Github | 9.3k | 16天 |
| 补充 | 开发工具 | [ActivityTracker](https://github.com/fashare2015/ActivityTracker) | 查看当前栈顶 Activity | 0.4k | 1月 |
| 补充 | 开发工具 | [lantern](https://github.com/getlantern/lantern) | 翻墙利器 | 38k | 2月 |
...
3. 『star 数』和『最近更新』是基于：2018-10-19 GitHub 项目数据进行参考。

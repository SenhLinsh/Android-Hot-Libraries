...
| UI | 图表 | [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) | 统计图表库 | 24k | 4天 |
| UI | 图表 | [hellocharts-android](https://github.com/lecho/hellocharts-android) | 统计图表库 | 6.1k | 7月 |
| UI | 图表 | [smartTable](https://github.com/huangyanbin/smartTable) | 自动生成表格框架[[详细]](#huangyanbin--smarttable) | 2.7k | 6月 |
| UI | 图表 | [AdaptiveTableLayout](https://github.com/Cleveroad/AdaptiveTableLayout) | 可阅读与编辑CSV文件的库 | 1.5k | 1年 |
| UI | 图表 | [TableView](https://github.com/evrencoskun/TableView) | 绘制表格 | 1.8k | 29天 |
| UI | 菜单 | [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu) | 比较早的一款侧滑菜单 | 11k | 4年 |
| UI | 菜单 | [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) | 侧滑菜单 | 9.7k | 6天 |
...
| UI | 图片 | [android-gif-drawable](https://github.com/koral--/android-gif-drawable) | Gif 加载 | 6.7k | 1天 |
| UI | 图片 | [Matisse](https://github.com/zhihu/Matisse) | 图片\视频选择库 | 8.1k | 4天 |
...
| UI | 弹窗 | [Toasty](https://github.com/GrenderG/Toasty) | 定制不一样的 Toast | 4.7k | 18天 |
...
| UI | 悬浮窗 | [FloatWindow](https://github.com/yhaolpz/FloatWindow) | 安卓任意界面悬浮窗 | 2.3k | 6月 |
...
| UI | 导航 | [MagicIndicator](https://github.com/hackware1993/MagicIndicator) | ViewPager 指示器框架 | 5.1k | 27天 |
| UI | 布局 | [flexbox-layout](https://github.com/google/flexbox-layout) | Android 弹性 / 流式布局 | 12k | 1天 |
...
| UI | 布局 | [rclayout](https://github.com/GcsSloop/rclayout) | Android 通用圆角布局 | 1.4k | 25天 |
...
| UI | 选择器 | [AndroidPicker](https://github.com/gzu-liyujiang/AndroidPicker) | 安卓选择器类库 | 4.0k | 3天 |
...
| UI | 高斯模糊 | [BlurKit-Android](https://github.com/wonderkiln/BlurKit-Android) | 高斯模糊控件 | 2.6k | 1天 |
...
| 网络 | 框架 | [retrofit](https://github.com/square/retrofit) | 网络框架 | 30k | 11天 |
| 网络 | 框架 | [okhttp](https://github.com/square/okhttp) | 网络框架 | 29k | 1天 |
| 网络 | 框架 | [volley](https://github.com/google/volley) | 网络框架 | 1.9k | 23天 |
| 网络 | 文件下载 | [FileDownloader](https://github.com/lingochamp/FileDownloader) | 文件下载引擎 | 7.5k | 1月 |
| 网络 | 进度监听 | [ProgressManager](https://github.com/JessYanCoding/ProgressManager) | okhttp 上传下载进度监听 | 1.8k | 5天 |
...
| 图片 | 压缩 | [Luban](https://github.com/Curzibn/Luban) | 最接近朋友圈的图片压缩算法 | 8.6k | 10天 |
| 图片 | 转换 | [glide-transformations](https://github.com/wasabeef/glide-transformations) | Glide 图像转换器 | 6.9k | 6月 |
| 图片 | 滤镜 | [android-gpuimage](https://github.com/CyberAgent/android-gpuimage) | 图像滤镜框架 | 5.4k | 2天 |
| 图片 | 选择器 | [Matisse](https://github.com/zhihu/Matisse) | 图片视频选择器 | 8.1k | 4天 |
| 图片 | 选择器 | [TakePhoto](https://github.com/crazycodeboy/TakePhoto) | 图片选择 / 剪裁 / 压缩 | 5.6k | 7月 |
...
| 视频 | 播放器 | [JieCaoVideoPlayer](https://github.com/lipangit/JieCaoVideoPlayer) | 节操视频播放器 | 7.9k | 4天 |
| 视频 | 播放器 | [ijkplayer](https://github.com/Bilibili/ijkplayer) | Bilibili 开源播放器 | 21k | 9月 |
| 视频 | 播放器 | [GSYVideoPlayer](https://github.com/CarGuo/GSYVideoPlayer) | 多功能视频播放器 | 7.8k | 9天 |
| 动画 | AE | [lottie-android](https://github.com/airbnb/lottie-android) | 展示 AE 工具所作动画的框架 | 23k | 15天 |
...
| 异步 | 链式 | [RxJava](https://github.com/ReactiveX/RxJava) | 事件驱动的基于异步数据流的编程模式 | 36k | 1天 |
| 异步 | 链式 | [RxAndroid](https://github.com/ReactiveX/RxAndroid) | Android 中的 RxJava 绑定 | 17k | 5天 |
| 异步 | 链式 | [agera](https://github.com/google/agera) | 谷歌开发的安卓链式编程框架 | 7.2k | 8月 |
| 数据库 | 轻量级 | [realm-java](https://github.com/realm/realm-java) | 轻量级数据库 | 10k | 1天 |
| 数据库 | 轻量级 | [greenDAO](https://github.com/greenrobot/greenDAO) | 轻量级数据库 | 10k | 2月 |
| 文件 | 选择器 | [Android-FilePicker](https://github.com/DroidNinja/Android-FilePicker) | 图片 / 文件选择器 | 1.6k | 14天 |
| json | 解析 | [gson](https://github.com/google/gson) | 谷歌官方 Json 库 | 14k | 8天 |
...
| 语言 | 汉字处理 | [HanLP](https://github.com/hankcs/HanLP) | 中文分词 、关键词提取等 | 9.4k | 1天 |
| AI | 深度学习 | [TensorFlow-android](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/android) | TensorFlow Android Demo | 113k | 19天 |
...
| 性能 | 生命周期 | [RxLifecycle](https://github.com/trello/RxLifecycle) | 使用 RxJava 管理生命周期 | 6.3k | 8天 |
...
| 插件化 | 框架 | [VirtualAPK](https://github.com/didi/VirtualAPK ) | 滴滴插件化框架 | 6.3k | 1月 |
...
| 虚拟化 | 虚拟化 | [VirtualApp](https://github.com/asLody/VirtualApp ) | App虚拟化引擎 | 4.8k | 10天 |
...
| 通信 | 路由 | [ARouter](https://github.com/alibaba/ARouter) | 辅助组件化改造的框架 | 7.7k | 8天 |
| 键盘 | 表情 | [XhsEmoticonsKeyboard](https://github.com/w446108264/XhsEmoticonsKeyboard) | 表情键盘解决方案 | 2.5k | 1年 |
| 键盘 | 冲突 | [JKeyboardPanelSwitch](https://github.com/Jacksgong/JKeyboardPanelSwitch) | 解决键盘面板冲突 | 3.1k | 25天 |
...
| 权限 | 请求 | [PermissionsDispatcher](https://github.com/hotchemi/PermissionsDispatcher) | 基于注解处理权限请求 | 8.1k | 6天 |
| 权限 | 请求 | [RxPermissions](https://github.com/tbruyelle/RxPermissions) | 基于 RxJava 处理权限请求 | 7.3k | 3月 |
| 响应式 | UI | [RxBinding](https://github.com/JakeWharton/RxBinding) | 安卓 UI 响应式编程 | 8.0k | 17天 |
| 响应式 | 事件 | [otto](https://github.com/square/otto) | 事件总线框架 | 5.1k | 6月 |
| hybrid | 框架 | [JsBridge](https://github.com/lzyzsd/JsBridge) | Android 与 JavaScript 互调桥梁 | 5.6k | 5天 |
| hybrid | 框架 | [VasSonic](https://github.com/Tencent/VasSonic) | 轻量级高性能的 hybrid 框架 | 8.6k | 5月 |
| 崩溃 | 报告 | [acra](https://github.com/ACRA/acra) | 崩溃信息收集框架 | 4.6k | 17天 |
| 崩溃 | 处理 | [CustomActivityOnCrash](https://github.com/Ereza/CustomActivityOnCrash) | 崩溃处理 | 2.6k | 11月 |
| 崩溃 | 预防 | [NullAway](https://github.com/uber/NullAway) | 检测 NullPointerExceptions | 2.3k | 10天 |
...
| 混淆 | 工具 | [AndResGuard](https://github.com/shwenzhang/AndResGuard) | Android 资源混淆工具 | 5.2k | 24天 |
| 测试 | 单元测试 | [robolectric](https://github.com/robolectric/robolectric) | Android 单元测试框架 | 4.2k | 3天 |
| 测试 | 单元测试 | [mockito](https://github.com/mockito/mockito) | Android 单元测试框架 | 7.7k | 3天 |
| 测试 | 单元测试 | [truth](https://github.com/google/truth) | 谷歌的断言和命题框架 | 1.5k | 14天 |
| 调试 | 框架 | [stetho](https://github.com/facebook/stetho) | Android 开发调试神器 | 10k | 17天 |
...
| Demo | MVP | [androidmvp](https://github.com/antoniolg/androidmvp) | Android 端 MVP 设计 APP | 5.4k | 4月 |
| Demo | 框架 | [android-architecture-components](https://github.com/googlesamples/android-architecture-components) | Architecture Component 官方演示 | 10k | 2天 |
| Demo | 测试 | [android-testing](https://github.com/googlesamples/android-testing) | 集成四大自动化测试框架的 Demo | 5.8k | 3天 |
...
| APP | 播放器 | [ExoPlayer](https://github.com/google/ExoPlayer) | 谷歌出品可扩展媒体播放器 | 11k | 29天 |
...
| 面试 | 指南 | [interviews](https://github.com/kdn251/interviews) | 软件工程技术面试个人指南 | 29k | 23天 |
...
| 学习 | 汇总 | [AndroidNote](https://github.com/GcsSloop/AndroidNote) | GcsSloop 个人学习笔记 | 5.7k | 29天 |
...
| 学习 | 算法 | [awesome-java-leetcode](https://github.com/Blankj/awesome-java-leetcode) | 学习数据结构和算法、刷 LeetCode | 4.6k | 11天 |
| 学习 | ADB | [awesome-adb](https://github.com/mzlogin/awesome-adb) | ADB 用法大全 | 4.8k | 4月 |
| 其他 | 大全 | [Android](https://github.com/open-android/Android) | GitHub 上最火的 Android 开源项目 | 5.5k | 1年 |
| 其他 | 大全 | [awesome-java](https://github.com/akullpp/awesome-java) | Java框架、库与软件合集 | 18k | 12天 |
| 其他 | 大全 | [awesome-android](https://github.com/JStumpp/awesome-android) | Android 实用资源合集 | 6.1k | 5天 |
...
| 其他 | 大全 | [AndroidLibs](https://github.com/XXApple/AndroidLibs) | Android 开源代码大全 | 4.7k | 1月 |
| 其他 | 大全 | [awesome-android-tips](https://github.com/jiang111/awesome-android-tips) | 收集常用的 Android 代码 | 2.3k | 23天 |
...
3. 『star 数』和『最近更新』是基于：2018-11-04 GitHub 项目数据进行参考。
